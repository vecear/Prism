...
const CACHE_NAME = 'prism-v100';
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/css/style.css?v=20260611i',
  '/js/ml.js?v=20260606a',
  '/js/app.js?v=20260611f',
  '/js/journal.js?v=20260611c',
  '/js/ibsync.js?v=20260611a',
  '/js/industry-data.js?v=20260612a',
  '/js/industry.js?v=20260611c',
  '/favicon.svg',
  '/manifest.json',
];
